...
class LCD
{
    ...
    public:
         ...
         */
        LCD(I2C_HandleTypeDef* i2c, int address = 0x4E);
        ...
        /**
         * @brief Send a number to the display starting at the cursor position
         * 
         * @param value `double`
         * @param decimals `int = 3` The number of decimals to display
         * @return `status_utils::StatusCode` OK if transmit was successful 
         */
        status_utils::StatusCode send_string(double value, int decimals = 3);
